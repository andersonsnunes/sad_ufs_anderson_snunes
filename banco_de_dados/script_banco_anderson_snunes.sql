...
CREATE TABLE IF NOT EXISTS `Locadora`.`Filme_tem_Ator` (
  ...
  `Filme_idcategoria` INT NOT NULL,
  `Ator_idAtor` INT NOT NULL,
  PRIMARY KEY (`Filme_idFilme`, `Filme_idcategoria`, `Ator_idAtor`),
  INDEX `fk_Filme_has_Ator_Ator1_idx` (`Ator_idAtor` ASC),
  INDEX `fk_Filme_has_Ator_Filme1_idx` (`Filme_idFilme` ASC, `Filme_idcategoria` ASC),
  CONSTRAINT `fk_Filme_has_Ator_Filme1`
    FOREIGN KEY (`Filme_idFilme` , `Filme_idcategoria`)
    REFERENCES `Locadora`.`Filme` (`idFilme` , `idcategoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
